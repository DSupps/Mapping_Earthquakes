...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // make a call to the major earthquake data from the GeoJSON Summary Feed for M4.5+ Earthquakes for the Past 7 Days.  
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {

  // 4. Same parameters in the styleInfo()
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
  ...
  // 5. change color function to use only three colors for magnitudes specified in legend.onAdd
  function getColor(magnitude) {
    if (magnitude > 5) {
      return "#ea2c2c";
    }
